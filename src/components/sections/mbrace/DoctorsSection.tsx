        ...
        <div className="mb-team-intro grid mb-7.5 items-center max-[1001px]:grid-cols-[1fr] min-[1001px]:grid-cols-[1fr_1fr] max-[1201px]:gap-6 min-[1201px]:gap-[35px] [&>div>p]:text-[14px]">
          <div>
            ...
            <div>
              ...
              <ul className="mb-doctor-meta list-none mt-4 pt-3.5 [border-top:1px_solid_#e6e1ea] text-[11px] text-care-purple flex flex-wrap gap-2.5 [&_li]:flex [&_li]:items-center [&_li]:gap-[7px] [&_span]:text-[#363435] [&_span]:font-medium [&_svg]:w-[17px] [&_svg]:h-[17px]">
                <li>
              ...
              <div className="mb-doctor-actions flex mt-5 max-[1201px]:gap-[5px] min-[1201px]:gap-2 max-[701px]:[&_.mb-button]:min-h-11 max-[701px]:[&_.mb-button]:whitespace-normal min-[701px]:[&_.mb-button]:min-h-[27px] min-[701px]:[&_.mb-button]:whitespace-nowrap max-[1001px]:[&_.mb-button]:pt-2 max-[1001px]:[&_.mb-button]:pr-2 max-[1001px]:[&_.mb-button]:pb-2 max-[1001px]:[&_.mb-button]:pl-2 max-[1001px]:[&_.mb-button]:text-[10px] min-[1001px]:max-[1201px]:[&_.mb-button]:pt-1.5 min-[1001px]:max-[1201px]:[&_.mb-button]:pr-[5px] min-[1001px]:max-[1201px]:[&_.mb-button]:pb-1.5 min-[1001px]:max-[1201px]:[&_.mb-button]:pl-[5px] min-[1001px]:max-[1201px]:[&_.mb-button]:text-[8px] min-[1201px]:[&_.mb-button]:pt-[7px] min-[1201px]:[&_.mb-button]:pr-2 min-[1201px]:[&_.mb-button]:pb-[7px] min-[1201px]:[&_.mb-button]:pl-2 min-[1201px]:[&_.mb-button]:text-[9px] [&_.mb-button]:flex-1 [&_.mb-button]:rounded-[2px]">
